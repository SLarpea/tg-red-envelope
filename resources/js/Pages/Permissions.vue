                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="d-flex justify-content-end align-items-center action-container">
                                                <a href="/permissions" class="btn btn-dark btn-sm"><i class="bi bi-recycle"></i> 刷新</a>
                                    ...
                                    <PaginationLayout
                                        :data="{ links: permissions.links, from: permissions.from, to: permissions.to, total: permissions.total }" />
