                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <SearchLayout :data="{ routeLink: 'permissions.index', filters: filters }" />
                                    ...
                                    <table class="table table-sm table-striped table-hover">
                                        ...
                                        <tbody>
                                            <tr v-for="(item, index) in permissions.data" :key="item.id" @dblclick.prevent="selectAction(item, 'show', null)">
                                    ...
                                    <PaginationLayout :data="{ links: permissions.links, from: permissions.from, to: permissions.to, total: permissions.total }" />
   ...
   methods: {
        ...
        formAction(data, type) {
            ...
            if (this.action == 'new') {
                ...
                confirmButtonColor = '#198754';
                method = 'PUT';
                routeURL = 'permissions.update';
                msgText = 'Work has been updated.';
            } else {
                text = "Are you sure you want to delete this item?";
                confirmButtonColor = '#D81B60';
                method = 'DELETE';
                routeURL = 'permissions.destroy';
