<template>
    ...
    <AppLayout>
        ...
        <div class="pagetitle">
            <h1><i class="bi bi-trophy"></i> Winning Record</h1>
            <nav>
                <ol class="breadcrumb">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <table class="table table-sm table-striped table-hover">
                                        ...
                                        <tbody>
                                            <tr v-for="(item, index) in winning.data" :key="item.id">
                                                <td class="text-center">{{ winning.from + index }}</td>
                                                <td>{{ item.lucky_id }}</td>
                                                <td>{{ item.amount }}</td>
                                                <td>{{ item.tg_id }}</td>
                                                <td>{{ item.group_id }}</td>
                                    ...
                                    <PaginationLayout
                                        :data="{ links: winning.links, from: winning.from, to: winning.to, total: winning.total }" />
